      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          <div className={`w-2 h-2 rounded-full ${
            status === 'healthy' || status === 'success' ? 'bg-green-500' : 
            status === 'warning' ? 'bg-yellow-500' : 'bg-red-500'
          }`} />
          <span className={`text-sm ${
            status === 'healthy' || status === 'success' ? 'text-green-600' : 
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
            ...
            <h4 className="text-lg font-semibold text-gray-900">Trending Classifier</h4>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
            ...
            <h4 className="text-lg font-semibold text-gray-900">Views Regressor</h4>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
            ...
            <h4 className="text-lg font-semibold text-gray-900">Content Clusterer</h4>
          ...
          <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-yellow-800">
                Mô hình chưa được huấn luyện. Vui lòng huấn luyện mô hình để xem các chỉ số hiệu suất.
              </span>
            </div>
          </div>
        )}
